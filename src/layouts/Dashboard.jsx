import { FaShoppingCart, FaHome, FaUtensils, FaBook, FaUsers } from "react-icons/fa";
  ...
  return (
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-content flex flex-col items-center justify-center">
        ...
        <label
          htmlFor="my-drawer-2"
          className="btn btn-primary drawer-button lg:hidden mt-3"
        >
          Open drawer
        </label>
      </div>
        ...
        <ul className="menu p-4 w-80 h-full bg-base-200 text-base-content">
          {isAdmin ? (
            <>
              ...
              <li>
                <NavLink to="all-users" className="active-link">
                  <FaUsers /> All Users
                </NavLink>
              </li>
            </>
